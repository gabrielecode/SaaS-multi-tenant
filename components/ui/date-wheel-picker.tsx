    ...
    >
      <div
        ...
        style={{
          height: centerOffset,
          background:
            "linear-gradient(to bottom, var(--wheel-bg, var(--background, #FAFAFA)) 0%, transparent 100%)",
        }}
        aria-hidden="true"
      />
      <div
        ...
        style={{
          height: centerOffset,
          background:
            "linear-gradient(to top, var(--wheel-bg, var(--background, #FAFAFA)) 0%, transparent 100%)",
        }}
        aria-hidden="true"
      />
