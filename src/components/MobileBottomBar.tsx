...
export default function MobileBottomBar({
  ...
  return (
    <nav 
      className="md:hidden fixed bottom-0 left-0 right-0 z-40 bg-white/95 backdrop-blur-xl border-t border-[#E4E6EA] shadow-lg px-2 py-1.5 pb-safe"
      ...
      {mode === 'staff_gateway' ? (
        ...
        <div className="grid grid-cols-3 items-center justify-around text-center">
          ...
          >
            ...
            <span className="text-[10px] mt-1 font-bold">Accessi Staff</span>
          </button>
          ...
          >
            <Globe className="w-5 h-5 text-[#1450FF]" />
        ...
        <div className="grid grid-cols-5 items-center justify-around text-center">
          ...
          <button
            ...
            className={`flex flex-col items-center justify-center py-2 px-1 rounded-[4px] transition-all duration-150 active:scale-95 ${
          ...
          >
            <div className="relative">
              ...
              {ownerSection === 'dashboard' && (
                <span className="absolute -bottom-1 left-1/2 -translate-x-1/2 w-1 h-1 bg-[#1450FF] rounded-full"></span>
              )}
            </div>
          ...
          >
            <div className="relative">
              ...
              {todayAppointmentsCount > 0 && (
                <span className="absolute -top-1 -right-2 bg-[#1450FF] text-white text-[9px] font-bold w-4 h-4 rounded-full flex items-center justify-center border border-white font-mono">
                  {todayAppointmentsCount}
                </span>
              )}
              {ownerSection === 'appointments' && (
          ...
          <div className="flex items-center justify-center">
            <button
              ...
              className="w-11 h-11 bg-[#1450FF] hover:bg-blue-600 text-white rounded-full flex items-center justify-center shadow-md transition-transform active:scale-95 border-2 border-white -mt-3"
        ...
        <div className="grid grid-cols-3 items-center justify-around text-center">
          ...
          <button
            onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}
            className="flex flex-col items-center justify-center py-2 px-1 rounded-[4px] text-purple-600 font-bold active:scale-95 transition"
          >
          ...
          <button
            ...
            className="flex flex-col items-center justify-center py-2 px-1 rounded-[4px] text-slate-500 hover:text-slate-900 font-medium active:scale-95 transition"
          >
            <LayoutDashboard className="w-5 h-5 text-[#1450FF]" />
